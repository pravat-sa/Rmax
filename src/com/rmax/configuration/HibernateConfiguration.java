package com.rmax.configuration;
...
@ComponentScan({ "com.rmax.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.rmax.model" });
    ...
    private Properties hibernateProperties() {
    	System.out.println("Inside hibernate property");
